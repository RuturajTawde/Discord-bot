module.exports = (msg, arg) => {
  ...
  msg.channel.send({
    embed: {
      ...
      description: 'This is a practice bot to learn Discord.js and have fun with friends on my Discord server. ',
      thumbnail: {
      ...
      fields: [
        ...
        },
        {
          ...
          value: "It will direct you to dota wiki page of mentioned hero's counter.",
          inline: false,
        },
        {
